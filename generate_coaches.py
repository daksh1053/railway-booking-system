...
COACH_CONFIG = {
    ...
    'RAC': {'seats': 36, 'base_fare': 0.6}  # RAC seats are half of sleeper seats
}
...
COACH_DISTRIBUTION = {
    'SuperFast': {
        ...
        'Sleeper': (0, 0),
        'General': (0, 0),
        'RAC': (1, 2)       # RAC coaches for SuperFast trains
    },
    'Express': {
        'AC1': (0, 1),
        'AC2': (1, 3),
        ...
        'Sleeper': (6, 10),
        'General': (3, 6),
        'RAC': (1, 2)       # RAC coaches for Express trains
    },
    'Passenger': {
        'AC1': (0, 0),
        'AC2': (0, 1),
        ...
        'Sleeper': (2, 4),
        'General': (6, 10),
        'RAC': (1, 1)       # RAC coaches for Passenger trains
    }
}
...
def generate_coach_id(train_number, coach_type, index):
    ...
    type_prefix = {
        ...
        'Sleeper': 'S',
        'General': 'G',
        'RAC': 'R'          # RAC coach prefix
    }
    # Use the last 4 digits instead of just 2
    return f"{type_prefix[coach_type]}{train_number % 10000:04d}{index:02d}"
