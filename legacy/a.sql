...
BEGIN
    ...
    DECLARE cur CURSOR FOR SELECT train_route_id FROM pending_route_updates;
    DECLARE CONTINUE HANDLER FOR NOT FOUND SET done = TRUE;
    ...
    TRUNCATE TABLE pending_route_updates;
END //
...
FOR EACH ROW
BEGIN
    INSERT IGNORE INTO pending_route_updates (train_route_id) VALUES (NEW.train_route_id);
END //
